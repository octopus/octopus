...
contains
  ...
  subroutine spectrum_add_pcm_dipole(dipole, time_steps, dt, nspin)
    ...
    character(len=22) :: asc_vs_t_unit_format
    ...
    do it = 1, time_steps
      ...
      write (asc_vs_t_unit_format, "(A6,I5,A11)") '(F14.8',pcm%n_tesserae,'(1X,F14.8))'

      ! writing real-time PCM charges and dipole, and the total dipole for debug purposes
      write(asc_vs_t_unit_check,fmt=trim(asc_vs_t_unit_format)) aux_float, ( pcm%q_e(ia) , ia=1,pcm%n_tesserae )
