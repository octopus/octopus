...
contains
  ...
  ! ---------------------------------------------------------
  subroutine td_write_init(writ, outp, gr, st, hm, geo, ks, ions_move, with_gauge_field, kick, iter, max_iter, dt)
 ...
 ! Nex = Nex + st%qtot 
  ...
  call io_function_output_global_BZ(outp%how, dir, "n_excited_el_kpt", gr%mesh, st%d%kpt, Nex_kpt, unit_one, err) 
