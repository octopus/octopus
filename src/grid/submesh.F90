...
! -------------------------------------------------------------
  ...
  ! -------------------------------------------------------------
    ...
    call comm_allreduce(this%mesh%mpi_grp, part_np)
    ...
    call comm_allreduce(this%mesh%mpi_grp, this%x_global)
    call comm_allreduce(this%mesh%mpi_grp, this%part_v)
    call comm_allreduce(this%mesh%mpi_grp, this%global2local)
