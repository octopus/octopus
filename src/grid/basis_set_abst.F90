...
module basis_set_abst_oct_m
  ...
  contains
    ...
    procedure(end),        public, deferred        :: end
    procedure(write_info), public, deferred        :: write_info
    procedure(dump),       public, deferred        :: dump
    procedure(load),       public, deferred        :: load
