...
contains
  ...
  subroutine curv_modine_init(cv, parser, sb, geo, spacing)
    ...
    !%End
    call parse_variable(dummy_parser, 'CurvModineXBar', M_ONE/M_THREE, cv%xbar)
    ...
    !% See N. A. Modine, G. Zumbach, and E. Kaxiras, <i>Phys. Rev. B</i> <b>55</b>, 10289-10301 (1997).
    !%End
    call parse_variable(dummy_parser, 'CurvModineJBar', M_HALF, cv%Jbar)
    ...
    !% See N. A. Modine, G. Zumbach, and E. Kaxiras, <i>Phys. Rev. B</i> <b>55</b>, 10289-10301 (1997).
    !%End
    call parse_variable(dummy_parser, 'CurvModineJlocal', CNST(0.25), cv%Jlocal(1))
    ...
    !% See N. A. Modine, G. Zumbach, and E. Kaxiras, <i>Phys. Rev. B</i> <b>55</b>, 10289-10301 (1997).
    !%End
    call parse_variable(dummy_parser, 'CurvModineJrange', M_TWO, cv%Jrange(1), units_inp%length)
