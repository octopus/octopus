...
contains
  ...
  subroutine oct_iterator_init(iterator, parser, par)
    ...
    !%End
    call parse_variable(dummy_parser, 'OCTEps', CNST(1.0e-6), iterator%eps)
    ...
    !%End
    call parse_variable(dummy_parser, 'OCTMaxIter', 10, iterator%ctr_iter_max)
    ...
    !%End
    call parse_variable(dummy_parser, 'OCTDumpIntermediate', .false., iterator%dump_intermediate)
