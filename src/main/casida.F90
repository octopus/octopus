...
contains
  ...
  subroutine casida_type_init(cas, sys)
    ...
    call restart_init(cas%restart_dump, RESTART_CASIDA, RESTART_TYPE_DUMP, mpi_world, sys%mc, ierr)
    call restart_init(cas%restart_load, RESTART_CASIDA, RESTART_TYPE_LOAD, mpi_world, sys%mc, ierr)
