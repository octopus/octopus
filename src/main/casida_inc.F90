...
contains
  ...
  subroutine X(K_term)(pp, qq, saved, mtxel_vh, mtxel_xc)
    ...
    ! This needs to be modified for GGA fxc:
    ! We need to calculate the gradient of rho_j and add the term rho_i*xc_grad*grad_rho_j
    ! where xc_grad is the vector function, generated by xc_get_derivs in case of GGA
