...
!! 02111-1307, USA.
  ...
  ! 
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/!
  subroutine sym_conjugate_gradients(np, x, b, op, iter, residue, threshold)
    ...
    FLOAT, allocatable :: r(:), ax(:), p(:), ap(:)
    FLOAT :: alpha, beta, gamma, threshold_
    integer :: max_iter
    ...
    call pop_sub(); return
  end subroutine sym_conjugate_gradients

  subroutine bi_conjugate_gradients(np, x, b, op, opt, iter, residue, threshold)
    integer, intent(in) :: np
    FLOAT,                intent(inout) :: x(:)
    FLOAT,                intent(in)    :: b(:)
    interface
    ...
    FLOAT, allocatable :: r(:), rr(:), ax(:), p(:), pp(:), ap(:), atp(:)
    ...
    call pop_sub(); return
  end subroutine bi_conjugate_gradients
