...
!    FLOAT, pointer :: system_E_field(:,:) !< E field generated by Maxwell system

    FLOAT, allocatable, public       :: partner_ep(:) !< pointer to permitivity of the linear medium
    FLOAT, allocatable, public       :: partner_mu(:) !< pointer to permeability of the linear medium
    FLOAT, allocatable, public       :: partner_sigma_e(:) !< pointer to permeability of the linear medium
    FLOAT, allocatable, public       :: partner_sigma_m(:) !< pointer to permeability of the linear medium
    integer, public                  :: partner_points_number !< pointer to number of points of linear medium
    integer, allocatable, public     :: partner_points_map(:) !< pointer to points map of linear medium
...
!    AFE_ALLOCATE(this%system_quantities(this%n_system_quantities))
!    this%system_quantities(1) = E_FIELD
!    nullify(this%system_efield)
  ...
  subroutine linear_medium_em_field_init(this)
