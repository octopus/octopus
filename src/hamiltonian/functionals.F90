...
!    XC_RELATIVISTIC         =   1
    ...
    case(XC_LDA_C_XALPHA)
      ...
      !%End
      call parse_variable(dummy_parser, 'Xalpha', M_ONE, alpha)
#ifdef HAVE_LIBXC4
      parameters(1) = alpha
    ...
    case(XC_LDA_X_1D, XC_LDA_C_1D_CSC)
      ...
      call parse_variable(dummy_parser, 'Interaction1D', INT_SOFT_COULOMB, interact_1d)
      ...
      call parse_variable(dummy_parser, 'Interaction1DScreening', M_ONE, alpha)
#ifdef HAVE_LIBXC4
    ...
    case(XC_GGA_X_LB)
      ...
      !%End
      call parse_variable(dummy_parser, 'LB94_modified', .false., lb94_modified)
      ...
      !%End
      call parse_variable(dummy_parser, 'LB94_threshold', CNST(1.0e-6), functl%LB94_threshold)
