...
subroutine X(hamiltonian_apply_batch) (hm, der, psib, hpsib, ik, terms, set_bc)
 ...
 if(hm%F%floquet_apply) then
     call X(apply_floquet_hamiltonian)(hm, der, psib, hpsib, ik, terms, set_bc)
  else
     call X(hamiltonian_apply_batch2)(hm, der, psib, hpsib, ik, terms, set_bc)
  end if
...
! ---------------------------------------------------------
subroutine X(hamiltonian_apply_batch2) (hm, der, psib, hpsib, ik, terms, set_bc)
  type(hamiltonian_t),   intent(in)    :: hm
  type(derivatives_t),   intent(in)    :: der
  type(batch_t), target, intent(inout) :: psib
  type(batch_t), target, intent(inout) :: hpsib
...
subroutine  X(apply_floquet_hamiltonian)(hm, der, psib, hpsib, ik, terms, set_bc)
  type(hamiltonian_t),   intent(in)    :: hm
  type(derivatives_t),   intent(in)    :: der
  type(batch_t), target, intent(inout) :: psib
  type(batch_t), target, intent(inout) :: hpsib
