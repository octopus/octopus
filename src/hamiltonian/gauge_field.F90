...
contains
  ...
  subroutine gauge_field_init(this, parser, sb)
    ...
    call parse_variable(dummy_parser, 'GaugeFieldDynamics', OPTION__GAUGEFIELDDYNAMICS__POLARIZATION, this%dynamics)
    ...
    call parse_variable(dummy_parser, 'GaugeFieldPropagate', .false., this%with_gauge_field)
    ...
    call parse_variable(dummy_parser, 'GaugeFieldDelay', M_ZERO, this%kicktime)
