...
module classical_particle_oct_m
  ...
  interface classical_particle_t
    procedure classical_particle_factory
  end interface classical_particle_t

contains
  ! ---------------------------------------------------------
  function classical_particle_factory(namespace) result(sys)
    class(classical_particle_t), pointer    :: sys
    type(namespace_t),       intent(in) :: namespace

    PUSH_SUB(classical_particle_factory)

    SAFE_ALLOCATE(sys)

    call sys%init(namespace)

    POP_SUB(classical_particle_factory)
  end function classical_particle_factory
