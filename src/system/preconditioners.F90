...
contains
  ...
  subroutine preconditioner_init(this, parser, gr)
    ...
    call parse_variable(dummy_parser, 'Preconditioner', default, this%which)
    ...
    case(PRE_FILTER)
      ...
      call parse_variable(dummy_parser, 'PreconditionerFilterFactor', default_alpha, alpha)
    ...
    if(this%which == PRE_MULTIGRID) then
      ...
      !%End
      call parse_variable(dummy_parser, 'PreconditionerIterationsPre', 1, this%npre)
      ...
      !% preconditioner. The default is 1.
      !%End
      call parse_variable(dummy_parser, 'PreconditionerIterationsMiddle', 1, this%nmiddle)
      ...
      !%End
      call parse_variable(dummy_parser, 'PreconditionerIterationsPost', 2, this%npost)
    end if
