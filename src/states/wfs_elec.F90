...
contains
  ...
  !--------------------------------------------------------------
  subroutine wfs_elec_clone_to(this, dest, pack, copy_data, np)
  ...
  !--------------------------------------------------------------
  subroutine wfs_elec_copy_to(this, dest, pack, copy_data, np)
    class(wfs_elec_t),  intent(in)    :: this
    ...
    class is (wfs_elec_t)
      ...
      call this%batch_t%copy_to(dest%batch_t, pack, copy_data, np)
    class default
