...
! local vars
    ...
    do itype = 1, modelmbparticles%ntype_of_particle
      ...
      call modelmb_sym_updown (ndimmb, npptype, &
      ...
      call modelmb_antisym_1spin (nspinup,             perms_up, ndimmb, npptype, ofst, &
             young%young_up(:,iyoung_in(itype)), gr, normalizer, antisymwf)
      ! antisymmetrize down spins amongst themselves
      call modelmb_antisym_1spin (nspindown_in(itype), perms_down, ndimmb, npptype, ofst, &
...
!> input 1 wave function, and symetrize wrt spin down labeled particles, according to the given young diagrams
  subroutine modelmb_sym_updown(ndimmb, npptype, &
...
! local vars
    ...
    POP_SUB(modelmb_sym_updown)
  end subroutine modelmb_sym_updown
 
  ! ---------------------------------------------------------

  subroutine modelmb_antisym_1spin(n1spin, perms_1spin, ndimmb, npptype, ofst, young_1spin, gr, normalizer, antisymwf)
...
! local vars
    ...
    PUSH_SUB(modelmb_antisym_1spin)
    ...
    POP_SUB(modelmb_antisym_1spin)

  end subroutine modelmb_antisym_1spin
