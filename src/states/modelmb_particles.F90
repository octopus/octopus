...
contains
  ...
  subroutine modelmb_particles_init(this, parser, gr)
    ...
    !%End
    call parse_variable(dummy_parser, 'NParticleModelmb', 0, this%nparticle)
    ...
    !%
    !%End
    call parse_variable(dummy_parser, 'NDimModelmb', 1, this%ndim)
    ...
    !%End
    call parse_variable(dummy_parser, 'NTypeParticleModelmb', 1, this%ntype_of_particle)
