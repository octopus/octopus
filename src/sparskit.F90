...
module sparskit
  ...
  public :: sparskit_solver_type, &
       dsparskit_solver_init, dsparskit_solver_run, dsparskit_solver_end, &
       zsparskit_solver_init, zsparskit_solver_run, zsparskit_solver_end

  ! the drivers (we make them public for direct calls)
  public :: dsk_driver_cg, dsk_driver_cgnr, dsk_driver_bcg, dsk_driver_dbcg, &
       dsk_driver_bcgstab, dsk_driver_tfqmr, dsk_driver_fom, dsk_driver_gmres, &
       dsk_driver_fgmres, dsk_driver_dqgmres
  public :: zsk_driver_cg, zsk_driver_cgnr, zsk_driver_bcg, zsk_driver_dbcg, &
       zsk_driver_bcgstab, zsk_driver_tfqmr, zsk_driver_fom, zsk_driver_gmres, &
       zsk_driver_fgmres, zsk_driver_dqgmres
