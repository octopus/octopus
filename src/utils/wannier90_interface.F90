...
contains
  ...
  subroutine generate_wannier_states(mesh, sb, geo, st)
    ...
    call io_function_read_what_how_when(sb, global_namespace, what, how, output_interval)
    ...
    do iw = 1, w90_num_wann
      ...
      call dio_function_output(how(1), 'wannier', trim(fname), global_namespace, mesh, &
