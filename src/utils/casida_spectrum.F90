...
program casida_spectrum
  ...
  call parse_variable(dummy_parser, 'SpinComponents', 1, cs%ispin)
  ...
  !%End
  call parse_variable(dummy_parser, 'CasidaSpectrumBroadening', CNST(0.005), cs%br, units_inp%energy)
  ...
  !%End
  call parse_variable(dummy_parser, 'CasidaSpectrumEnergyStep', CNST(0.001), cs%energy_step, units_inp%energy)
  ...
  !%End
  call parse_variable(dummy_parser, 'CasidaSpectrumMinEnergy', M_ZERO, cs%min_energy, units_inp%energy)
  ...
  !%End
  call parse_variable(dummy_parser, 'CasidaSpectrumMaxEnergy', M_ONE, cs%max_energy, units_inp%energy)
