...
!---------------------------------------------------------------------------------
subroutine mesh_init_1(sb, mesh, geo, cv, enlarge)
  ...
  call push_sub('mesh.mesh_init_1')
  ...
  call pop_sub()
end subroutine mesh_init_1


!---------------------------------------------------------------------------------
subroutine mesh_init_2(sb, mesh, geo, cv)
...
!---------------------------------------------------------------------------------
subroutine mesh_init_3(mesh, geo, cv, stencil, np_stencil, mc)
  type(mesh_type),       intent(inout) :: mesh
  type(geometry_type),   intent(in)    :: geo
  type(curvlinear_type), intent(in)    :: cv
