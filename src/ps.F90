...
subroutine ps_debug(ps, dir)
  ...
  info_unit   = io_open(trim(dirname)//'/info')
  local_unit  = io_open(trim(dirname)//'/local')
  dlocal_unit = io_open(trim(dirname)//'/local_derivative')
  localw_unit = io_open(trim(dirname)//'/local_ft')
  nl_unit     = io_open(trim(dirname)//'/nonlocal')
  dnl_unit    = io_open(trim(dirname)//'/nonlocal_derivative')
  nlw_unit    = io_open(trim(dirname)//'/nonlocal_ft')
  so_unit     = io_open(trim(dirname)//'/so')
  dso_unit    = io_open(trim(dirname)//'/so_derivative')
  sow_unit    = io_open(trim(dirname)//'/so_ft')
  wave_unit   = io_open(trim(dirname)//'/wavefunctions')
