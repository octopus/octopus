...
contains
 ...
 subroutine orbitalbasis_init(this)
  ...
  !%End
  call parse_variable(dummy_parser, 'AOTruncation', OPTION__AOTRUNCATION__AO_FULL, this%truncation)
  ...
  !%End
  call parse_variable(dummy_parser, 'AOThreshold', CNST(0.01), this%threshold)
  ...
  !%End
  call parse_variable(dummy_parser, 'AONormalize', .true., this%normalize)
  ...
  !%End
  call parse_variable(dummy_parser, 'AOSubmeshForPeriodic', .false., this%submeshforperiodic)
  ...
  !%End
  call parse_variable(dummy_parser, 'AOLoewdin', .false., this%orthogonalization)
