...
#elif defined TEMPLATE_NAME && defined TEMPLATE_LEVEL
#define ITEMPLATE_PREFIX DECORATE(TEMPLATE_NAME,TEMPLATE_LEVEL)
...
#define ITEMPLATE_2(PREFIX,NAME) DECORATE(PREFIX,NAME)
