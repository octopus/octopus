...
module ssys_density_m
  ...
  use base_density_m, only:                      &
    ssys_density_start => base_density__start__, &
    ssys_density_stop  => base_density__stop__
...
contains
  ...
  ! ---------------------------------------------------------
  subroutine ssys_density_update(this)
    ...
    POP_SUB(ssys_density_update)
    return
  end subroutine ssys_density_update
