...
/* TODO: Fortran Datatypes MPI_COMPLEX MPI_DOUBLE_COMPLEX are missing */
...
int NBC_Operation(void *buf3, void *buf1, void *buf2, MPI_Op op, MPI_Datatype type, int count) {
  ...
  if(type == MPI_INT) { 
    ...
    if(op == MPI_LAND) {
      ...
      for(i=0; i<count; i++) {
        *(((char*)buf3) + i) = ((*(((char*)buf1) + i) ? 1 : 0) ^ (*(((char*)buf2) + i) ?  1 : 0)); 
      }
    ...
    if(op == MPI_SUM) {
      for(i=0; i<count; i++) {
        ...
        floatcplx *ptr1, *ptr2, *ptr3;
                            
        ptr1 = ((floatcplx*)buf1) + i;
        ptr2 = ((floatcplx*)buf2) + i;
        ptr3 = ((floatcplx*)buf3) + i;
    ...
    if(op == MPI_SUM) {
      for(i=0; i<count; i++) {
        ...
        doublecplx *ptr1, *ptr2, *ptr3;
                            
        ptr1 = ((doublecplx*)buf1) + i;
        ptr2 = ((doublecplx*)buf2) + i;
        ptr3 = ((doublecplx*)buf3) + i;
