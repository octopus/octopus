...
PyYAML_path = "/local/binaries/gfortran-bindings-fpe/install/lib/python2.7/site-packages"
if not PyYAML_path == "system":
  sys.path.insert(0, PyYAML_path)
sys.path.insert(0, "/local/genovese/work/BigDFT/1.8/futile/tests")
...
# path of the script
path = "/local/genovese/work/BigDFT/1.8/futile/tests"
