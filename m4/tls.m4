...
AC_DEFUN([AX_TLS], [
  ...
  if test "$ac_cv_tls" != "none"; then
    ...
    # "TLS_SPECIFIER", but TLS had a reasonably high chance of conflicting
    ...
    AC_DEFINE_UNQUOTED([TLS_SPECIFIER], , [If the compiler supports a TLS storage class define it to that here])
  fi
