...
oct-cross-section - Calculates the absorption cross section tensor.

=head1 SYNOPSIS

=over

=item B<oct-cross-section>

=back

[oct-cross-section does not read the standard input: all standard input
will be simply ignored. An input file named F<inp> must be present
in the running directory.
Also, oct-cross-section accepts no command line arguments, since there is
