...
which pseudopoentials are available.
...
The following command would run the octopus_cmplx executable to
calculate the He atom.

prompt> B<oct-run_periodic_table> -s He -x octopus_cmplx
